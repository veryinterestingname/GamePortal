...
public class CardGame {
    ...
    protected void initializeGame() {
        ...
        playAgain = new ClickableRectangle(BlackjackGUI.gameWidth / 2 - 50, 310, 100, 35, "Play Again");
    ...
    public void switchTurns() { playerOneTurn = !playerOneTurn; }
    public String getCurrentPlayer() { return playerOneTurn ? "Player One" : "Player Two"; }
